Contributing to Bloom Core
============================

The Bloom Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bloomcoin-project/bloomcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Bloom Core project, and is not to be
confused with overall Bloom Network Protocol consensus changes.

Whether a pull request is merged into Bloom Core rests with the project merge
...
Patches that change Bloom consensus rules are considerably more involved than
...
Where a patchset proposes to change the Bloom consensus, it must have been
...
The project leader is the release manager for each Bloom Core release.
