...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bloom features */
        {"bloomcoin", "listmasternodes", &listmasternodes, true },
        {"bloomcoin", "getmasternodecount", &getmasternodecount, true },
        {"bloomcoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"bloomcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"bloomcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"bloomcoin", "masternodecurrent", &masternodecurrent, true },
        {"bloomcoin", "startmasternode", &startmasternode, true },
        {"bloomcoin", "createmasternodekey", &createmasternodekey, true },
        {"bloomcoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"bloomcoin", "listmasternodeconf", &listmasternodeconf, true },
        {"bloomcoin", "getmasternodestatus", &getmasternodestatus, true },
        {"bloomcoin", "getmasternodewinners", &getmasternodewinners, true },
        {"bloomcoin", "getmasternodescores", &getmasternodescores, true },
        {"bloomcoin", "preparebudget", &preparebudget, true },
        {"bloomcoin", "submitbudget", &submitbudget, true },
        {"bloomcoin", "mnbudgetvote", &mnbudgetvote, true },
        {"bloomcoin", "getbudgetvotes", &getbudgetvotes, true },
        {"bloomcoin", "getnextsuperblock", &getnextsuperblock, true },
        {"bloomcoin", "getbudgetprojection", &getbudgetprojection, true },
        {"bloomcoin", "getbudgetinfo", &getbudgetinfo, true },
        {"bloomcoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"bloomcoin", "mnfinalbudget", &mnfinalbudget, true },
        {"bloomcoin", "checkbudgets", &checkbudgets, true },
        {"bloomcoin", "mnsync", &mnsync, true },
        {"bloomcoin", "spork", &spork, true },
...
{
    return "> bloomcoin-cli " + methodname + " " + args + "\n";
}
