...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bloom bloomcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bloomcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bloomcoin transaction") + "\n" +
                               "  bloomcoin-tx [options] -create [commands]   " + _("Create hex-encoded bloomcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bloomcoin transaction
