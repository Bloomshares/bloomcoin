...
/* Bloom GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Bloom"
#define QAPP_ORG_DOMAIN "bloomcoin.org"
#define QAPP_APP_NAME_DEFAULT "Bloom-Qt"
#define QAPP_APP_NAME_TESTNET "Bloom-Qt-testnet"
