...
#include "qt/bloomcoin/forms/ui_dashboardwidget.h"
#include "qt/bloomcoin/sendconfirmdialog.h"
#include "qt/bloomcoin/txrow.h"
    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of Bloom earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 Bloom");
...
void DashboardWidget::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Bloom")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair Bloom, zDCT
