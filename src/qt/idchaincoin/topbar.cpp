...
#include "qt/bloomcoin/forms/ui_topbar.h"
#include "qt/bloomcoin/loadingdialog.h"
#include "qt/bloomcoin/lockunlock.h"
#include "qt/bloomcoin/qtutils.h"
#include "qt/bloomcoin/receivedialog.h"
                                                        ...
                                                        ui(new Ui::TopBar)
{
    ...
    ui->pushButtonConf->setButtonText("bloomcoin.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open bloomcoin.conf with default application"));
}
