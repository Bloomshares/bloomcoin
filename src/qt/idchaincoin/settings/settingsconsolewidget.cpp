...
#include "qt/bloomcoin/settings/settingsconsolewidget.h"
#include "qt/bloomcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/bloomcoin/settings/moc_settingsconsolewidget.cpp"
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(CMD_REPLY, (tr("Welcome to the Bloom RPC console.") + "<br>" +
