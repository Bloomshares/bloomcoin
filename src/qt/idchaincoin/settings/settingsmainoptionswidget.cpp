...
#include "qt/bloomcoin/settings/settingsmainoptionswidget.h"
#include "qt/bloomcoin/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
    ...
    ui(new Ui::SettingsMainOptionsWidget)
{
    ...
    // Switch
    ui->pushSwitchStart->setText(tr("Start Bloom on system login"));
