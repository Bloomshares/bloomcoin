...
/** Utility functions used by the Bloom Qt UI.
 */
namespace GUIUtil
{
...
// Render Bloom addresses in monospace font
...
// Parse "bloomcoin:" URI into recipient object, return true on successful parsing
