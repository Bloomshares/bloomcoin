...
class ReorgStakeTest(IDChainCoinTestFramework):
    ...
    def check_money_supply(self, expected_heirs, expected_zheirs):
        ...
        # verify that nodes have the expected Bloom and zDCT supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check Bloom and zDCT supply at the beginning
        # ------------------------------------------
        ...
        # Bloom supply: block rewards minus burned fees for minting
        ...
        # Verify that Bloom and zDCT supplies were properly updated after the spends and reorgs
        self.log.info("Check Bloom and zDCT supply...")
