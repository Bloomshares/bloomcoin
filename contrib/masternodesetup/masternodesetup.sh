...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='bloomcoin.conf'
CONFIGFOLDER='/root/.bloomcoin'
COIN_DAEMON='bloomcoind'
COIN_CLI='bloomcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/bloomcoin/Bloom/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
