...
def main():
    ...
    # Filter out hosts with multiple bloomcoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple bloomcoin ports' % (ip_stats(ips)), file=sys.stderr)
