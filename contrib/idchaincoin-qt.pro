...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bloomcoin-cli.cpp \
           src/bloomcoin-tx.cpp \
           src/bloomcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/bloomcoin.qrc src/qt/bloomcoin_locale.qrc

TRANSLATIONS += src/qt/locale/bloomcoin_bg.ts \
                src/qt/locale/bloomcoin_de.ts \
                src/qt/locale/bloomcoin_en.ts \
                src/qt/locale/bloomcoin_es.ts \
                src/qt/locale/bloomcoin_fi.ts \
                src/qt/locale/bloomcoin_fr.ts \
                src/qt/locale/bloomcoin_it.ts \
                src/qt/locale/bloomcoin_ja.ts \
                src/qt/locale/bloomcoin_pl.ts \
                src/qt/locale/bloomcoin_pt.ts \
                src/qt/locale/bloomcoin_ru.ts \
                src/qt/locale/bloomcoin_sk.ts \
                src/qt/locale/bloomcoin_sv.ts \
                src/qt/locale/bloomcoin_vi.ts \
                src/qt/locale/bloomcoin_zh_CN.ts \
                src/qt/locale/bloomcoin_zh_TW.ts
