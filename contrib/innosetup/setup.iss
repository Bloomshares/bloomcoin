...
#define MyAppName "Bloom Core"
#define MyAppPublisher "2023 Bloom Core Developers"
#define MyAppURL "https://bloomcoin.net"
#define MyAppExeName "bloomcoin-qt.exe"
#define MyAppExtraData "https://explorer.bloomcoin.net/bootstraps/Bloom/bootstrap.zip"
...
[Files]
Source: ".\package\bloomcoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Bloom\Bloom-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Bloom\Bloom-Qt,strDataDir|{userappdata}\Bloom\}');
  Result := True;
end;
