...
The script [extract-osx-sdk.sh](https://github.com/bloomcoin-project/bloomcoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
bloomcoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/bloomcoin-project/bloomcoin/blob/master/doc/README_osx.md) for troubleshooting tips.
